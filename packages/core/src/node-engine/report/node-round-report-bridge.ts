...
import type { NodeRoundPhaseSnapshot, NodeRoundShadowResult } from "../phase/round-phase-runner.js";
...
export function buildNodeRoundCommittedReport(input: BuildNodeRoundCommittedReportInput): NodeRoundCommittedReport {
  ...
  return {
    ...
    notes: [
      ...
      "正式 winner 只来�?WinConditionMaterializer 的硬胜负条件，LLM shadow 不拥有最终胜负写入权�?"
    ]
  };
}

  ...
  return (
    <section className={styles.timelinePanel}>
      <div className={styles.playbackHeader}>
        <div>
          <h2>Round / Phase 播放控制</h2>
          <p>这里播放的是已经提交的 hex trace，不会重新执行 LLM，也不会重新计算 winner。</p>
        </div>
      ...
      <ProgressLine label="当前回合 phase 进度" value={props.phaseProgressPct} />
          ...
          {props.phases.map((phase) => {
            ...
            return (
              ...
              >
                ...
                <small>
                  A{phase.aliveAttackCount}/D{phase.aliveDefenseCount} - calls {phase.callsAttempted}
                </small>
                <small>
                  accepted {phase.acceptedActionCount} / rejected {phase.rejectedDraftCount} / fallback {phase.fallbackActionCount}
                </small>
              </button>
            );
          })}

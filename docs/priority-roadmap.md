...
```text
docs/p-phase-delivery-framework.md
```
...
```text
1. docs/domain-schema.md
2. docs/event-taxonomy.md
3. docs/rules-format.md
4. docs/round-report-contract.md
5. docs/token-economy.md
6. docs/llm-driver-contract.md
7. docs/simulation-engine.md
8. docs/local-persistence.md
9. docs/live-timeline.md
```

原因：

- 这些文档已经覆盖事实源、事件、规则、回合战报、经济、驾驶员、比赛推进流程和本地持久化。
...
- 不再等待 P2.2 / P2.3 / P3 / P4 全部文档完成。
- 工程实现必须遵守 P0 / P1 / P2.1 已冻结契约。
...
```text
2. docs/tactical-map.md
3. docs/broadcast-system.md
```
...
```text
5. docs/stats-awards.md
6. docs/news-media.md
7. docs/materials-library.md
8. docs/api-contract.md
9. docs/queue-worker.md
10. docs/observability-cost.md
11. docs/web-migration.md
```
...
Upstream:
  - 回合战报（RoundReport）.key_events.zone
  - MapMaterials.zones

...
docs/index/current-docs.md：当前必读清单。
docs/index/archive-log.md：历史迁移记录。
docs/index/backlog-index.md：长期设想索引。
docs/phase-plans/phase-2.0-pre-hex-engine-implementation-plan.md：Hex 当前实施口径。
docs/phase-plans/phase-2.0-pre-hex-engine-runtime-contract.md：Hex runtime 契约。
```

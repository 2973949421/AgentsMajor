...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    if (!progress) {
      return NextResponse.json(
        {
          error: `Web runner mode/match mismatch. Supported pairs: ${phase17CanonIds.matchId} -> phase17_showcase_match, ${phase18CanonIds.fixtureId} -> phase18_next_round|phase18_current_map|phase18_keep_generating_map|phase18_full_bo3. Hex runs use /hex-lab/match.`
        },
        { status: 400 }
      );
    }
        ...
        summary:
          validation.mode === "phase18_next_round"
            ...
            : validation.mode === "phase18_current_map"
              ...
              : validation.mode === "phase18_keep_generating_map"

...
import { commitDust2HexRoundExperimental } from "../packages/core/dist/index.js";

const args = process.argv.slice(2);
const shouldCommit = args.includes("--commit");
if (!shouldCommit) {
  throw new Error("phase20-hex-commit-round requires explicit --commit.");
}

const mapSlug = readArg("--map", "dust2");
if (mapSlug.toLowerCase() !== "dust2") {
  throw new Error(`Only --map dust2 is supported in N29; received ${mapSlug}.`);
}
      ...
      JSON.stringify(
        {
          ...
          traceSource: result.roundReport.nodeTraceSource,

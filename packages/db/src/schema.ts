...
export const teamMapCoachStates = sqliteTable(
  "team_map_coach_states",
  {
    ...
    tokenBank: integer("token_bank").notNull().default(5000),
...
export const economyStates = sqliteTable(
  "economy_states",
  {
    ...
    lossCount: integer("loss_count").notNull().default(1),
    economyPosture: text("economy_posture"),
    loadoutPackage: text("loadout_package"),
...
export const llmCalls = sqliteTable(
  "llm_calls",
  {
    ...
    repaired: integer("repaired", { mode: "boolean" }),
    createdAt: text("created_at").notNull()
  },
  (table) => ({

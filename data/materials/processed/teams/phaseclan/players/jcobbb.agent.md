...
## Persona
更年轻的新前线位，适合在 PhaseClan 里承担新鲜冲击点的职责。
...
- 新闻标签：special_invite, money-superteam, upset-watch
- 跨圈标签：customer_service_to_cleanup

## Future Interfaces
- agent 人格接口：special_invite, money-superteam, upset-watch, rifle-worker, round-connector, fresh-opener
- 模型绑定接口：llm_role_template_rifler / driver_qwen_3_6_plus
- 模型运行状态：v1 asset preallocation only，runtime_enabled=false
- 产品运营接口：新前线, special_invite, money-superteam, upset-watch

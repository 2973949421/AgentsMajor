...
## Persona
黑马线真正能抬头的火力点。只要连续出镜，就应该被提升成标题人物。
...
## Future Interfaces
- agent 人格接口：upset-watch, research-chaos, rifle-worker, round-connector, understated-star
- 模型绑定接口：llm_role_template_rifler / driver_qwen_3_6_plus
- 模型运行状态：v1 asset preallocation only，runtime_enabled=false
- 产品运营接口：关键输出, upset-watch, research-chaos
